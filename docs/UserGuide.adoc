...
Format: `add n/NAME ic/NRIC pwd/PASSWORD p/PHONE_NUMBER e/EMAIL a/ADDRESS [t/TAG]...`
...
* `add n/John Doe ic/T0249855I pwd/9EwciT p/98765432 e/johnd@example.com a/John street, block 123, #01-01`
...
* `edit n/John Doe ic/s1234567h pwd/NeUeR2018 ep/91234567 ee/johndoe@example.com` +
Edits the phone number and email address of the 1st person to be `91234567` and `johndoe@example.com` respectively.
* `edit n/John Doe2 ic/s1234567h pwd/NeUeR2018 en/John Doe` +
...
Logs into the app using a user's NRIC and password. +
Format: `login ic/NRIC pwd/PASSWORD` +

=== Logs out of the application: `logout`
Logs out of the current session. +
Format: `logout`

=== Check the current user that is logged into the application: `checkloginstatus`
Prints the NRIC that is logged into the current session. +
Format: `checkloginstatus`

=== Setting password: `setpass`
Set password for employee on the address book. +
Format: `setpass ic/s1234567h pwd/PASSWORD` +
...
Format: `superuser n/NAME ic/s1234567h pwd/PASSWORD` +
Example: `superuser n/John Doe ic/s1234567h pwd/888888`
...
Format: `payroll n/NAME ic/NRIC pwd/PASSWORD` +
Example: `payroll n/John Doe ic/s1234567h pwd/NeUeR2018`

=== Check off days: `checkoffstatus`
Checks the number of off days available and off application status for an employee. +
Format: `checkoffstatus ic/NRIC pwd/PASSWORD` +
Example: `checkoffstatis ic/S9486222J pwd/NeUeR2018`

=== Apply off days: `applyoff`
Apply off days for employee. +
Format: `applyoff n/NAME ic/NRIC pwd/PASSWORD date/DATE` +
Example: `applyoff n/John Doe ic/s123457h pwd/NeUeR2018 date/080818` +
====
...
•	*Access payroll*: `payroll n/NAME ic/NRIC pwd/PASSWORD`
•	*Apply off days*: `applyoff n/NAME ic/NRIC pwd/PASSWORD date/DATE`
•	*Edit particulars*: `edit n/NAME ic/NRIC pwd/PASSWORD [en/NAME] [ep/PHONE] [ee/EMAIL] [ea/ADDRESS]....`
...
•	*Switch to superuser*: `superuser n/NAME ic/s1234567h pwd/PASSWORD`
